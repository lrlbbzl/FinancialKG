...
def get_neighbor_desc(head_id: str, tail_id: str = None) -> str:
    ...
    entities = [entity_dict.get_entity_by_id(n_id).entity for n_id in neighbor_ids] # neighbors' name
...
class Example:
    ...
    def vectorize(self) -> dict:
        ...
        head_text = _concat_name_desc(head_word, head_desc) # entity: desc
        hr_encoded_inputs = _custom_tokenize(text=head_text,
                                             text_pair=self.relation) # self.relation has been str
